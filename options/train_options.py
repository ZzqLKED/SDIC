...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--learning_rate', default=0.001, type=float, help='Optimizer learning rate')#0.001
        ...
        self.parser.add_argument('--model', default='CGI_Stereo', help='select a model structure', choices=__models__.keys())
        self.parser.add_argument('--maxdisp', type=int, default=192, help='maximum disparity')
